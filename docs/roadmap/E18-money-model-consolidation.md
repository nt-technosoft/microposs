...
### Фаза 1 — Честный профит→капитал
- [ ] T-1.1 Спроектировать честный тип/проводку «прибыль → капитал» (GL-эффект = текущему).
- [ ] T-1.2 Заменить `_settle_partner_from_profit`: убрать фиктивные DIVIDEND_PAID + contribution.
- [ ] T-1.3 Golden: FROM_PROFIT-сценарий — числа/GL/conservation идентичны; в истории нет фантомов.
...
- [ ] T-8.3 Ужесточить ε: точный 0 по UZS-карманам, ε только native-FX.
