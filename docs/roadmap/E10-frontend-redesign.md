...
**Статус:** `IN_PROGRESS`
**Прогресс:** ~35% (Фаза 0 фундамент; список приходов; shell детальной страницы + секция финансирования)
...
- [ ] T-1.3 Пересобрать остальные секции детальной страницы (товары, расходы, оплата, приёмка, история) — пока в старом стиле внутри нового shell.
...
- [ ] T-1.4 Verify (ширины, состояния, контраст зелёных) по мере готовности секций
